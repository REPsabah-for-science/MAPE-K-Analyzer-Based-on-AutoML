...
def loadData():
    ...
    for i in range(1, c + 1):
        data_path = f'/content/drive/MyDrive/DELTAIoT1/raw/dataset_with_all_features{i}.json'
...
def analyzeFeatureSelection(selected_features):
    ...
    output_file_path = '/content/drive/MyDriveL/DELTAIoT1/Binary_dataset_with_selected_features.json'
...
input_path = '/content/drive/MyDrive/DELTAIoT1/Binary_dataset_with_selected_features.json'
...
with open('/content/drive/MyDrive/DELTAIoT1/Binary_dataset_with_selected_features.json', 'r') as f:
